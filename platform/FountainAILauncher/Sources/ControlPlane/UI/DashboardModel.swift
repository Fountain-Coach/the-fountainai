...
/// Lightweight dashboard representation that always compiles, regardless of
/// SwiftUI availability. Encodes supervisor state for HTML/Markdown rendering
/// and provides a simple surface for tests.
